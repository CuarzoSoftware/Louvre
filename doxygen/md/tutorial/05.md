...
To enable the Louvre system to utilize our custom `EOutput` class, we must complete one remaining task: overriding its virtual constructor, specifically the Louvre::LCompositor::createOutputRequest() method.
