...
Stay calm! Here, we are currently using the default implementation provided by Louvre. I'll explain the purpose of each function shortly. But first, let's proceed to override the Louvre::LPointer virtual constructor (Louvre::LCompositor::createPointerRequest()).
