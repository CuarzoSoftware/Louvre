...
In this code section, we handle interactive resizing or movement of toplevel windows, elaborated further in [Chapter 10: Toplevels](md_md_tutorial_10.html). 
...
The Louvre::LScene::handlePointerMoveEvent() method returns the first view located at the specified coordinates. It's important to note that this method may return `nullptr` if no view is found.\n
