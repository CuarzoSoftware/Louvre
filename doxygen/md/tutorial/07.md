...
void ESurface::minimizedChanged()
{
    ...
    if (minimized())
    {
        ...
        thumbnail = tmpScene.texture()->copyB(
            LSize((THUMBNAIL_HEIGHT * tmpScene.texture()->sizeB().w())/tmpScene.texture()->sizeB().h(), THUMBNAIL_HEIGHT) * 2, false);
