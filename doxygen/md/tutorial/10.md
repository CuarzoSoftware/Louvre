...
In the constructor, we add the black fullscreen view to the fullscreen layer and initially hide it. 
...
As we relocate the fullscreen toplevels and their child surfaces into the black fullscreen view, it's essential to ensure that any newly created child surfaces are also moved. To accomplish this, we can override the Louvre::LSurface::parentChanged() virtual method.
