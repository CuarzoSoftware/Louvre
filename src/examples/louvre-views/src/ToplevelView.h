...
class ToplevelView final : public LLayerView {
 public:
  ...
  UITextureView decoTL, decoT, decoTR, decoL, decoR, decoBL, decoB, decoBR,
      maskBL, maskBR;

  InputRect topbarInput, buttonsContainer, resizeT, resizeB, resizeL, resizeR,
      resizeTL, resizeTR, resizeBL, resizeBR;

  ToplevelButton closeButton, minimizeButton, maximizeButton;
