...
#define TOPLEVEL_ACTIVE_TOP_LEFT_TRANS_REGION                        \
  {LRect(0, 0, 48, 74), LRect(48, 0, 22, 32), LRect(48, 31, 11, 11), \
   LRect(48, 60, 22, 14)}
#define TOPLEVEL_ACTIVE_TOP_RIGHT_TRANS_REGION                       \
  {LRect(22, 0, 48, 74), LRect(0, 0, 22, 32), LRect(11, 31, 11, 11), \
   LRect(0, 60, 22, 14)}
...
#define TOPLEVEL_INACTIVE_TOP_LEFT_TRANS_REGION                      \
  {LRect(0, 0, 41, 63), LRect(41, 0, 15, 27), LRect(41, 26, 11, 11), \
   LRect(41, 55, 15, 8)}
#define TOPLEVEL_INACTIVE_TOP_RIGHT_TRANS_REGION                    \
  {LRect(15, 0, 41, 63), LRect(0, 0, 15, 27), LRect(4, 26, 11, 11), \
   LRect(0, 55, 15, 8)}
...
class G {
 public:
  ...
  // Quick handles
  static Compositor *compositor() { return (Compositor *)Louvre::compositor(); }
  ...
  // Utils
  static LTexture *loadAssetsTexture(const std::filesystem::path &file,
