...
///@{
    /*!
     * @brief Last pointer enter event serial.
     *
     * Last serial sent to a client when one of its surfaces gains pointer focus.
     */
    UInt32 lastPointerEnterEventSerial() const;

    /*!
     * @brief Last pointer leave event serial.
     *
     * Last serial sent to a client when one of its surfaces loses pointer focus.
     */
    UInt32 lastPointerLeaveEventSerial() const;

    /*!
     * @brief Last pointer button event serial.
     *
     * Last serial sent to a client through sendButtonEvent().
     */
