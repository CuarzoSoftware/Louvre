...
#include <globals/Wayland/Region.h>
#include <globals/Wayland/Compositor.h>
...
#include <globals/XdgShell/XdgWmBase.h>
#include <globals/XdgShell/xdg-shell.h>

#include <globals/XdgDecoration/XdgDecorationManager.h>
#include <globals/XdgDecoration/xdg-decoration-unstable-v1.h>

#include <globals/LinuxDMA-BUF/LinuxDMABuf.h>
...
#include <globals/LinuxDMA-BUF/LGbm.h>
...
{
    // Create seat global
    wl_global_create(display, &wl_seat_interface, LOUVRE_SEAT_VERSION, seat->compositor(), &Globals::Seat::bind);
}
...
int LWayland::initWayland(LCompositor *comp)
{
    ...
    wl_global_create(display, &wl_data_device_manager_interface, LOUVRE_DATA_DEVICE_MANAGER_VERSION, comp, &Globals::DataDeviceManager::bind);//3
    ...
    // Create xdg decoration global
    wl_global_create(display, &zxdg_decoration_manager_v1_interface, LOUVRE_XDG_DECORATION_MANAGER_VERSION, comp, &Extensions::XdgDecoration::Manager::bind);

    // Create dma buf global
    //wl_global_create(display, &zwp_linux_dmabuf_v1_interface, 3, comp, &Extensions::LinuxDMABuf::LinuxDMABuf::bind);
