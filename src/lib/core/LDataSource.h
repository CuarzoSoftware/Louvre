...
public:   
     ...
     */
    Wayland::RDataSource *dataSourceResource() const;

    LPRIVATE_IMP(LDataSource)

    friend class Wayland::RDataSource;
    friend class Wayland::RDataDevice;
    LDataSource(Wayland::RDataSource *dataSourceResource);
    ~LDataSource();
};
