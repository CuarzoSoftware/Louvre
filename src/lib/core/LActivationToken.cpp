...
const std::unordered_map<std::string, LActivationToken *>::iterator
LActivationToken::destroy() const noexcept {
...
LActivationToken::LActivationToken(LClient *creator, LSurface *origin,
