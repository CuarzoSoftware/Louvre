...
public:
     ...
     *
     * This is just a utility function used by the default LPointer implementation to ensure that pointer focus remains
     ...
     *
     * @note This function is unrelated to drag & drop sessions.
     *
     ...
     *
     * This function returns the surface that is currently being actively pressed by the left pointer button.
     * It is set using the setDraggingSurface() utility function to ensure that pointer focus remains on the surface
     ...
     *
     * If the cursor role has been destroyed or if a client has requested to hide the cursor, this function returns `nullptr`.
     *
...
///@{
     ...
     * Override this virtual method if you need to be informed when the pointer changes its position by a delta (dx, dy).
     *
     * @note Some input backends, like X11, do not work with relative values and trigger pointerPosChangeEvent() instead.
     *
     * @param dx The relative position of the x-component of the pointer from its previous position.
     * @param dy The relative position of the y-component of the pointer from its previous position.
     *
    ...
    /**
     * @brief Pointer position change event
     *
     * This virtual method notifies a change in the pointer position generated by the input backend.\n
     * Override this virtual method if you need to be informed when the pointer changes its position to (x, y).
     *
     * @note Some input backends, like Libinput, do not work with absolute values and trigger pointerMoveEvent() instead.
     *
     * @param x The absolute position of the x-component of the pointer.
     * @param y The absolute position of the y-component of the pointer.
     *
     * #### Default Implementation
