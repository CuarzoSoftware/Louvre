 ...
 *
 * The LPointer class has virtual methods that let you listen to pointer events generated by devices like a mouse, trackpad, etc
 * generated by the input backend.\n
 * It has utility methods to interactively move and resize Toplevel surfaces, send pointer events to client surfaces, and more.\n
