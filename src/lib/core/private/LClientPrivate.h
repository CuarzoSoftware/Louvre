...
class LClient::LClientPrivate {
 public:
  LClientPrivate(LClient *lClient, wl_client *wlClient) noexcept
      : client{wlClient}, lastCursorRequest{lClient} {}
  ...
  std::vector<XdgDecoration::GXdgDecorationManager *>
  ...
  std::vector<FractionalScale::GFractionalScaleManager *>
      fractionalScaleManagerGlobals;
  std::vector<GammaControl::GGammaControlManager *> gammaControlManagerGlobals;
  std::vector<TearingControl::GTearingControlManager *>
      tearingControlManagerGlobals;
  std::vector<RelativePointer::GRelativePointerManager *>
  ...
  std::vector<PointerConstraints::GPointerConstraints *>
      pointerConstraintsGlobals;
  std::vector<LayerShell::GLayerShell *> layerShellGlobals;
  std::vector<ForeignToplevelManagement::GForeignToplevelManager *>
      foreignToplevelManagerGlobals;
  std::vector<ForeignToplevelList::GForeignToplevelList *>
      foreignToplevelListGlobals;
  std::vector<SinglePixelBuffer::GSinglePixelBufferManager *>
  ...
  std::vector<ImageCaptureSource::GOutputImageCaptureSourceManager *>
      outputImageCaptureSourceManagerGlobals;
  std::vector<ImageCaptureSource::GForeignToplevelImageCaptureSourceManager *>
      foreignToplevelImageCaptureSourceManagerGlobals;
  std::vector<WlrOutputManagement::GWlrOutputManager *> wlrOutputManagerGlobals;
  std::vector<BackgroundBlur::GBackgroundBlurManager *>
      backgroundBlurManagerGlobals;
  std::vector<SvgPath::GSvgPathManager *> svgPathManagerGlobals;
  std::vector<InvisibleRegion::GInvisibleRegionManager *>
      invisibleRegionManagerGlobals;
