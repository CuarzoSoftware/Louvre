...
struct LGraphicBackendInterface {
  ...
  /* TEXTURES */
  bool (*textureCreateFromCPUBuffer)(LTexture *texture, const LSize &size,
  ...
  bool (*textureCreateFromGL)(LTexture *texture, GLuint id, GLenum target,
                              UInt32 format, const LSize &size,
                              bool transferOwnership);
  bool (*textureUpdateRect)(LTexture *texture, UInt32 stride, const LRect &dst,
                            const void *pixels);
  bool (*textureWriteBegin)(LTexture *texture);
  bool (*textureWriteUpdate)(LTexture *texture, UInt32 stride, const LRect &dst,
                             const void *pixels);
  ...
  // The assigned type must always later be the same value returned by
  // outputGetContentType()
