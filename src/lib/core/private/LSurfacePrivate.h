...
// Changes that are notified at the end of a commit after all changes are
// applied
...
LBitset<StateFlags> stateFlags{ReceiveInput | InfiniteInput | BufferReleased |
                               VSync};
...
std::vector<PresentationTime::RPresentationFeedback *>
    presentationFeedbackResources;
