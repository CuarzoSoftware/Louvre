 ...
 *
 * The LRGBF struct defines an RGB color with three floating-point components
 ...
 *
 * The LRGBAF struct defines an RGBA color with four floating-point components
 * (r, g, b, a).\n Each component ranges from 0.0 to 1.0.
 */
struct LRGBAF {
 ...
 * of [glBlendFuncSeparate()](https://docs.gl/es2/glBlendFuncSeparate) for more
 * information.
 */
struct LBlendFunc {
