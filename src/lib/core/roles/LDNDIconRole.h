 ...
 * SRC="https://lh3.googleusercontent.com/evKJ2MbTJ42-qFYSP02NPxUULSFpTz3oBSqn6RvR20u_r5wvgJpHF6o-3Zg7aWgNBhrkIsM8iNWiQQHxPjvGml9zDB2wwNwWK0scqTsHpLIbxMqYv60afSruzbWNBCDZaGI_y77eRA=w2400"></center>
 */
...
class Louvre::LDNDIconRole : public LBaseSurfaceRole {
 public:
  ...
  static constexpr LFactoryObject::Type FactoryObjectType =
      LFactoryObject::Type::LDNDIconRole;
   ...
   *
   * The position of the icon given the role is calculated by subtracting the
   * hotspot from LSurface::pos().
   *
   * #### Default implementation
