...
bool LLayerView::nativeMapped() const noexcept { return true; }

const LPoint &LLayerView::nativePos() const noexcept { return m_nativePos; }

const LSize &LLayerView::nativeSize() const noexcept { return m_nativeSize; }

Float32 LLayerView::bufferScale() const noexcept { return 1.f; }
