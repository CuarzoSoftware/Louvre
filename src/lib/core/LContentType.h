...
namespace Louvre
{
     ...
     *
     * Hint regarding the type of content being displayed.
     *
    ...
    enum LContentType
    {
        ...
        LContentTypePhoto  = 1, ///< Content derived from digital still pictures that may be presented with minimal processing.
