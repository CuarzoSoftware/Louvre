...
class Louvre::LPointerMoveEvent final : public LPointerEvent {
 public:
   ...
   */
  LPointerMoveEvent(const LPointF &delta = LPointF(0.f, 0.f),
  ...
  /**
   * @brief Sets the unaccelerated movement delta along the x-axis of the
   * pointer.
   */
  ...
  /**
   * @brief Sets the unaccelerated movement delta along the y-axis of the
   * pointer.
   */
  ...
  /**
   * @brief The surface or view local position where the pointer is positioned
