...
public:
    ...
    */
     ...
     */
    Protocols::Wayland::SurfaceResource *surfaceResource() const;

    /*!
     * @brief xdg_surface resource
     *
     * Returns the resource generated by the [xdg_surface](https://wayland.app/protocols/xdg-shell#xdg_surface) interface of the XDG Shell protocol.\n
     * If the surface does not have the Popup or Toplevel role, the method returns nullptr.
     */
