...
public:
     ...
     *
     * This function sends a Ping event to the client, which is expected to acknowledge it by invoking the `pong()` virtual method. It is primarily used to detect if a client is unresponsive.
     *
     ...
     *
     * This function returns a pointer to the native `wl_client` struct associated with the client. The `wl_client` struct is part of the original Wayland library.
     *
     ...
     *
     * This function returns a constant reference to a list of LSurface pointers, representing the surfaces created by the client.
     *
     ...
     *
     * Use this function to forcefully and immediately flush any pending Wayland client events.
     ...
     *
     * This function terminates the client's connection with the compositor, which is equivalent to invoking `wl_client_destroy()`.
