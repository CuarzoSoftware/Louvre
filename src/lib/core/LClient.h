...
public:
     ...
     */
    list<Protocols::Wayland::SeatGlobal*> &seatGlobals() const;

    /*!
     * @brief Resources generated when the client binds to the **wl_data_device_manager** singleton global of the Wayland protocol.
     */
    Protocols::Wayland::DataDeviceManagerGlobal* dataDeviceManagerGlobal() const;
