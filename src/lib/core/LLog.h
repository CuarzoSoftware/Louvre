 ...
 * The level of verbosity can be assigned setting the **LOUVRE_DEBUG**
 * environment variable to a non negative integer value.\n
 *
 * All messages are directed to the **stdout** stream, except for those
 * generated by error() and fatal(), which are written to the **stderr** stream.
 *
 * ## Verbosity levels
 *
 * #### LOUVRE_DEBUG=0
