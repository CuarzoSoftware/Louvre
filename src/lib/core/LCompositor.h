...
public:
    ...
    /**
     * @brief Get a vector of all initialized outputs.
     *
     ...
     *
     * Use this event to handle the successful initialization of LCursor.\n
     * It is recommended to load cursor textures within this method.
     * The LXCursor class provides the LXCursor::load() method for loading pixmaps of XCursors available on the system.
     *
     * The default implementation includes a commented example demonstrating how to load XCursor pixmaps and assign them to LCursor.
     *
     * @par Default Implementation
