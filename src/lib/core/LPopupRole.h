...
/// @{
     ...
     *
     * Sends a Ping event to the client, which must respond by invoking the pong() virtual method.\n
     * Used to detect if a client is still "alive".
     *
     * @param serial Serial that the client must return in pong().
     */
    ...
    /*!
     * @brief Acknowledge a repositioning request.
     *
