...
#define LPRIVATE_CLASS(class_name)                                       \
  class class_name::CAT(class_name, Private) {                           \
   public:                                                               \
    ...
    CAT(class_name, Private) &operator=(const CAT(class_name,            \
                                                  Private) &) = delete;
...
/**
 * @brief Structure representing a version in the format
 ...
 *
 * This method provides access to the single LCompositor instance that can exist
 * per process.\n
 *
 * @return A pointer to the LCompositor instance or `nullptr` if not yet
 * created.
 */
 ...
 *
 * @warning Must be accessed within or after the LCompositor::initialized() or
 * LCompositor::cursorInitialized() events.
 *
 ...
 *
 * The seat provides access to the LClipboard, LDND, LPointer, LKeyboard,
 * LTouch, and LOutput instances.
 *
 * @warning Must be accessed within or after the LCompositor::initialized()
 * event.
 *
