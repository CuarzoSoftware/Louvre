...
void GXdgDecorationManager::bind(wl_client *client, void * /*data*/,
...
GXdgDecorationManager::GXdgDecorationManager(wl_client *client, Int32 version,
                                             UInt32 id) noexcept
...
void GXdgDecorationManager::get_toplevel_decoration(
  ...
  new RXdgToplevelDecoration(
      static_cast<GXdgDecorationManager *>(wl_resource_get_user_data(resource)),
      xdgToplevelRoleRes.toplevelRole(), id);
}
