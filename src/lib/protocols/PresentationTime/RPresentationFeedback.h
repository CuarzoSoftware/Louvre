...
class Louvre::Protocols::PresentationTime::RPresentationFeedback final
    : public LResource {
 public:
  ...
  void presented(UInt32 tv_sec_hi, UInt32 tv_sec_lo, UInt32 tv_nsec,
                 UInt32 refresh, UInt32 seq_hi, UInt32 seq_lo,
 ...
 private:
  ...
  RPresentationFeedback(GPresentation *presentarionRes, LSurface *surface,
                        UInt32 id) noexcept;
