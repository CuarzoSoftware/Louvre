...
class Louvre::Protocols::BackgroundBlur::RBackgroundBlur final
    : public LResource {
 public:
  ...
  static void set_round_rect_mask(wl_client *client, wl_resource *resource,
                                  ...
                                  Int32 radBL);
  static void set_svg_path_mask(wl_client *client, wl_resource *resource,
                                wl_resource *svgPath);

 private:
  friend class GBackgroundBlurManager;
  RBackgroundBlur(LBitset<LBackgroundBlur::MaskingCapabilities> maskCaps,
                  Wayland::RSurface *surfaceRes, UInt32 id,
