...
class Louvre::Protocols::PointerGestures::RGestureSwipe final
    : public LResource {
 public:
  ...
  // Since 1
  void begin(const LPointerSwipeBeginEvent &event,
 ...
 private:
  ...
  RGestureSwipe(Wayland::RPointer *pointerRes, Int32 id,
