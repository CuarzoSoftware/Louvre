...
class Louvre::Protocols::PointerGestures::GPointerGestures final
    : public LResource {
 public:
  static void get_swipe_gesture(wl_client *client, wl_resource *resource,
                                UInt32 id, wl_resource *pointer) noexcept;
  static void get_pinch_gesture(wl_client *client, wl_resource *resource,
                                UInt32 id, wl_resource *pointer) noexcept;
  ...
  static void get_hold_gesture(wl_client *client, wl_resource *resource,
                               UInt32 id, wl_resource *pointer) noexcept;
#endif
