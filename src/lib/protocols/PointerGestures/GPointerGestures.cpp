...
void GPointerGestures::bind(wl_client *client, void * /*data*/, UInt32 version,
                            UInt32 id) noexcept {
...
GPointerGestures::GPointerGestures(wl_client *client, Int32 version,
                                   UInt32 id) noexcept
...
void GPointerGestures::get_swipe_gesture(wl_client * /*client*/,
...
void GPointerGestures::get_pinch_gesture(wl_client * /*client*/,
                                         wl_resource *resource, UInt32 id,
                                         wl_resource *pointer) noexcept {
  new RGesturePinch(
      static_cast<Wayland::RPointer *>(wl_resource_get_user_data(pointer)), id,
...
#if LOUVRE_POINTER_GESTURES_VERSION >= 2
void GPointerGestures::release(wl_client * /*client*/,
...
#if LOUVRE_POINTER_GESTURES_VERSION >= 3
void GPointerGestures::get_hold_gesture(wl_client * /*client*/,
                                        wl_resource *resource, UInt32 id,
                                        wl_resource *pointer) noexcept {
  new RGestureHold(
      static_cast<Wayland::RPointer *>(wl_resource_get_user_data(pointer)), id,
