...
void GViewporter::bind(wl_client *client, void * /*data*/, UInt32 version,
                       UInt32 id) noexcept {
  new GViewporter(client, version, id);
}

Int32 GViewporter::maxVersion() noexcept { return LOUVRE_VIEWPORTER_VERSION; }

const wl_interface *GViewporter::interface() noexcept {
  return &wp_viewporter_interface;
}

GViewporter::GViewporter(wl_client *client, Int32 version, UInt32 id) noexcept
...
void GViewporter::get_viewport(wl_client * /*client*/, wl_resource *resource,
...
void GViewporter::destroy(wl_client * /*client*/,
