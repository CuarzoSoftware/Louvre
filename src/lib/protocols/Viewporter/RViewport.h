...
class Louvre::Protocols::Viewporter::RViewport final : public LResource {
 public:
  ...
  const LSize &dstSize() const noexcept { return m_dstSize; }
  const LRectF &srcRect() const noexcept { return m_srcRect; }

  /******************** REQUESTS ********************/

  static void destroy(wl_client *client, wl_resource *resource) noexcept;
  static void set_source(wl_client *client, wl_resource *resource, Float24 x,
                         Float24 y, Float24 width, Float24 height) noexcept;
  static void set_destination(wl_client *client, wl_resource *resource,
