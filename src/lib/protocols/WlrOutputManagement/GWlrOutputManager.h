...
class Louvre::Protocols::WlrOutputManagement::GWlrOutputManager final
    : public LResource {
 public:
  UInt32 lastDoneSerial() const noexcept { return m_serial; }

  /******************** REQUESTS ********************/

  static void create_configuration(wl_client *client, wl_resource *resource,
                                   UInt32 id, UInt32 serial);
