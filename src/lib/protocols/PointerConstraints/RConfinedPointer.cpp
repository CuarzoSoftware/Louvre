...
RConfinedPointer::RConfinedPointer(GPointerConstraints *pointerConstraintsRes,
                                   LSurface *surface,
...
void RConfinedPointer::set_region(wl_client * /*client*/, wl_resource *resource,
                                  wl_resource *region) noexcept {
  auto &res{
      *static_cast<RConfinedPointer *>(wl_resource_get_user_data(resource))};
