...
void GPointerConstraints::bind(wl_client *client, void * /*data*/,
...
GPointerConstraints::GPointerConstraints(wl_client *client, Int32 version,
                                         UInt32 id) noexcept
...
void GPointerConstraints::destroy(wl_client * /*client*/,
                                  wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GPointerConstraints::lock_pointer(wl_client * /*client*/,
  ...
  if (surfaceRes.surface()->imp()->lockedPointerRes ||
      surfaceRes.surface()->imp()->confinedPointerRes) {
  ...
  new RLockedPointer(
      static_cast<GPointerConstraints *>(wl_resource_get_user_data(resource)),
      surfaceRes.surface(),
...
void GPointerConstraints::confine_pointer(wl_client * /*client*/,
                                          wl_resource *resource, UInt32 id,
                                          wl_resource *surface,
                                          wl_resource *pointer,
                                          wl_resource *region,
