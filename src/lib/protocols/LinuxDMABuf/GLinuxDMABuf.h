...
class Louvre::Protocols::LinuxDMABuf::GLinuxDMABuf final : public LResource {
 public:
  ...
  static void create_params(wl_client *client, wl_resource *resource,
                            UInt32 id) noexcept;

#if LOUVRE_LINUX_DMA_BUF_VERSION >= 4
  static void get_default_feedback(wl_client *client, wl_resource *resource,
                                   UInt32 id);
  static void get_surface_feedback(wl_client *client, wl_resource *resource,
