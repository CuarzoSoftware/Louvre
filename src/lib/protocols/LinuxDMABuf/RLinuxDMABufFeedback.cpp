...
RLinuxDMABufFeedback::RLinuxDMABufFeedback(GLinuxDMABuf *linuxDMABufRes,
                                           UInt32 id) noexcept
    : LResource(linuxDMABufRes->client(),
...
void RLinuxDMABufFeedback::destroy(wl_client * /*client*/,
