...
void GSessionLockManager::bind(wl_client *client, void * /*data*/,
...
GSessionLockManager::GSessionLockManager(wl_client *client, Int32 version,
                                         UInt32 id) noexcept
...
void GSessionLockManager::destroy(wl_client * /*client*/,
                                  wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GSessionLockManager::lock(wl_client * /*client*/, wl_resource *resource,
                               UInt32 id) noexcept {
  new RSessionLock(
      static_cast<GSessionLockManager *>(wl_resource_get_user_data(resource)),
      id);
}
