...
class Louvre::Protocols::SessionLock::RSessionLockSurface final
    : public LResource {
 public:
  ...
  RSessionLock *sessionLockRes() const noexcept { return m_sessionLockRes; }
 ...
 private:
  ...
  RSessionLockSurface(RSessionLock *sessionLockRes, LSurface *surface,
                      LOutput *output, UInt32 id);
  ~RSessionLockSurface();
