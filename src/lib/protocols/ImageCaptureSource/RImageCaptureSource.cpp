...
RImageCaptureSource::RImageCaptureSource(LClient *client, Int32 version,
                                         UInt32 id,
                                         LImageCaptureSourceType type,
                                         LResource *source) noexcept
    : LResource(client, &ext_image_capture_source_v1_interface, version, id,
                &imp),
      m_source(source),
      m_type(type) {}
...
void RImageCaptureSource::destroy(wl_client * /*client*/,
