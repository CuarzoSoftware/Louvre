...
void GRelativePointerManager::bind(wl_client *client, void * /*data*/,
...
GRelativePointerManager::GRelativePointerManager(wl_client *client,
                                                 Int32 version,
                                                 UInt32 id) noexcept
...
GRelativePointerManager::~GRelativePointerManager() noexcept {
  LVectorRemoveOneUnordered(client()->imp()->relativePointerManagerGlobals,
                            this);
}

void GRelativePointerManager::destroy(wl_client * /*client*/,
                                      wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GRelativePointerManager::get_relative_pointer(
    wl_client * /*client*/, wl_resource *resource, UInt32 id,
    wl_resource *pointer) noexcept {
  new RRelativePointer(
      static_cast<Wayland::RPointer *>(wl_resource_get_user_data(pointer)), id,
