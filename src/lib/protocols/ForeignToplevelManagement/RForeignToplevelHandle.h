...
class Louvre::Protocols::ForeignToplevelManagement::RForeignToplevelHandle final
    : public LResource {
 public:
  GForeignToplevelManager *foreignToplevelManagerRes() const noexcept {
    return m_foreignToplevelManagerRes;
  }
  ...
  static void set_rectangle(wl_client *client, wl_resource *resource,
                            wl_resource *surface, Int32 x, Int32 y, Int32 width,
                            Int32 height);
 ...
 private:
  ...
  RForeignToplevelHandle(GForeignToplevelManager &foreignToplevelManagerRes,
