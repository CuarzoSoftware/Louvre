...
class Louvre::Protocols::ForeignToplevelList::GForeignToplevelList final
    : public LResource {
 public:
  /*
   ...
   */
  bool stopRequested() const noexcept { return m_stopped; }

  // No more toplevel events are sent
  bool finishedSent() const noexcept { return m_finished; }
