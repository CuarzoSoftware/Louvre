...
void GInvisibleRegionManager::bind(wl_client *client, void * /*data*/,
...
GInvisibleRegionManager::GInvisibleRegionManager(wl_client *client,
                                                 Int32 version,
                                                 UInt32 id) noexcept
...
GInvisibleRegionManager::~GInvisibleRegionManager() noexcept {
  LVectorRemoveOneUnordered(client()->imp()->invisibleRegionManagerGlobals,
                            this);
}

/******************** REQUESTS ********************/

void GInvisibleRegionManager::destroy(wl_client * /*client*/,
                                      wl_resource *resource) {
  wl_resource_destroy(resource);
}

void GInvisibleRegionManager::get_invisible_region(wl_client * /*client*/,
                                                   wl_resource *resource,
                                                   UInt32 id,
                                                   wl_resource *surface) {
  auto *surfaceRes{
  ...
  new RInvisibleRegion(surfaceRes, id, wl_resource_get_version(resource));
}
