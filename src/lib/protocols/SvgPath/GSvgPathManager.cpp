...
void GSvgPathManager::bind(wl_client *client, void * /*data*/, UInt32 version,
                           UInt32 id) noexcept {
...
GSvgPathManager::GSvgPathManager(wl_client *client, Int32 version,
                                 UInt32 id) noexcept
...
void GSvgPathManager::get_svg_path(wl_client * /*client*/,
                                   wl_resource *resource, UInt32 id) {
  new RSvgPath(
      static_cast<GSvgPathManager *>(wl_resource_get_user_data(resource)), id,
