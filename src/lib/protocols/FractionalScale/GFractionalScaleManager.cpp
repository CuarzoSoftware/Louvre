...
void GFractionalScaleManager::bind(wl_client *client, void * /*data*/,
...
GFractionalScaleManager::GFractionalScaleManager(wl_client *client,
                                                 Int32 version,
                                                 UInt32 id) noexcept
...
GFractionalScaleManager::~GFractionalScaleManager() noexcept {
  LVectorRemoveOneUnordered(client()->imp()->fractionalScaleManagerGlobals,
                            this);
}

/******************** REQUESTS ********************/

void GFractionalScaleManager::destroy(wl_client * /*client*/,
                                      wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GFractionalScaleManager::get_fractional_scale(
