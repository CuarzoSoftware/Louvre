...
void GContentTypeManager::bind(wl_client *client, void * /*data*/,
...
GContentTypeManager::GContentTypeManager(wl_client *client, Int32 version,
                                         UInt32 id) noexcept
...
void GContentTypeManager::destroy(wl_client * /*client*/,
                                  wl_resource *resource) {
  wl_resource_destroy(resource);
}

void GContentTypeManager::get_surface_content_type(wl_client * /*client*/,
                                                   wl_resource *resource,
                                                   UInt32 id,
                                                   wl_resource *surface) {
  auto *surfaceRes{
  ...
  if (surfaceRes->contentTypeRes()) {
    surfaceRes->postError(WP_CONTENT_TYPE_MANAGER_V1_ERROR_ALREADY_CONSTRUCTED,
