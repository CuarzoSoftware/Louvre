...
class Louvre::Protocols::XdgActivation::RXdgActivationToken final
    : public LResource {
 public:
  /******************** REQUESTS ********************/

  static void set_serial(wl_client *client, wl_resource *resource,
                         UInt32 serial, wl_resource *seat);
  static void set_app_id(wl_client *client, wl_resource *resource,
                         const char *app_id);
  static void set_surface(wl_client *client, wl_resource *resource,
                          wl_resource *surface);
 ...
 private:
  ...
  RXdgActivationToken(GXdgActivation *xdgActivationRes, UInt32 id) noexcept;
