...
struct zwlr_layer_surface_v1_interface {
   ...
   * @since 2
   */
  void (*set_layer)(struct wl_client *client, struct wl_resource *resource,
                    uint32_t layer);
  /**
 ...
 */
static inline void zwlr_layer_surface_v1_send_configure(
    struct wl_resource *resource_, uint32_t serial, uint32_t width,
    uint32_t height) {
  wl_resource_post_event(resource_, ZWLR_LAYER_SURFACE_V1_CONFIGURE, serial,
                         width, height);
}
 ...
 * @param resource_ The client's resource
 */
static inline void zwlr_layer_surface_v1_send_closed(
