...
void GXdgOutputManager::bind(wl_client *client, void * /*data*/, UInt32 version,
                             UInt32 id) noexcept {
...
GXdgOutputManager::GXdgOutputManager(wl_client *client, Int32 version,
                                     UInt32 id) noexcept
...
void GXdgOutputManager::destroy(wl_client * /*client*/,
                                wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GXdgOutputManager::get_xdg_output(wl_client * /*client*/,
                                       wl_resource *resource, UInt32 id,
                                       wl_resource *output) noexcept {
  new RXdgOutput(
      static_cast<Wayland::GOutput *>(wl_resource_get_user_data(output)), id,
