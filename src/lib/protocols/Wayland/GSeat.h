...
class Louvre::Protocols::Wayland::GSeat final : public LResource {
 public:
  ...
  static void get_pointer(wl_client *client, wl_resource *resource,
                          UInt32 id) noexcept;
  static void get_keyboard(wl_client *client, wl_resource *resource,
                           UInt32 id) noexcept;
  static void get_touch(wl_client *client, wl_resource *resource,
                        UInt32 id) noexcept;
