...
class Louvre::Protocols::Wayland::RSurface final : public LResource {
 public:
  ...
  Viewporter::RViewport *viewportRes() const noexcept { return m_viewportRes; }
  ...
  static void damage(wl_client *client, wl_resource *resource, Int32 x, Int32 y,
  ...
  static void damage_buffer(wl_client *client, wl_resource *resource, Int32 x,
                            Int32 y, Int32 w, Int32 h);
#endif

#if LOUVRE_WL_COMPOSITOR_VERSION >= 5
  static void offset(wl_client *client, wl_resource *resource, Int32 x,
                     Int32 y);
#endif
  ...
  static void apply_commit(LSurface *surface,
                           LBaseSurfaceRole::CommitOrigin origin =
                               LBaseSurfaceRole::CommitOrigin::Itself);
