...
static const struct wl_seat_interface imp{.get_pointer = &GSeat::get_pointer,
...
void GSeat::bind(wl_client *client, void * /*data*/, UInt32 version,
                 UInt32 id) noexcept {
  new GSeat(client, version, id);
}

Int32 GSeat::maxVersion() noexcept { return LOUVRE_WL_SEAT_VERSION; }

const wl_interface *GSeat::interface() noexcept { return &wl_seat_interface; }

GSeat::GSeat(wl_client *client, Int32 version, UInt32 id) noexcept
