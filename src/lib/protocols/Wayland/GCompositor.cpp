...
void GCompositor::bind(wl_client *client, void * /*data*/, UInt32 version,
                       UInt32 id) noexcept {
...
GCompositor::GCompositor(wl_client *client, Int32 version, UInt32 id) noexcept
...
void GCompositor::create_surface(wl_client * /*client*/, wl_resource *resource,
                                 UInt32 id) {
  new RSurface(static_cast<GCompositor *>(wl_resource_get_user_data(resource)),
               id);
}

void GCompositor::create_region(wl_client * /*client*/, wl_resource *resource,
                                UInt32 id) noexcept {
  new RRegion(static_cast<GCompositor *>(wl_resource_get_user_data(resource)),
              id);
}
