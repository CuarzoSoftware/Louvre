...
class Louvre::Protocols::Wayland::GDataDeviceManager final : public LResource {
 public:
  static void create_data_source(wl_client *client, wl_resource *resource,
                                 UInt32 id) noexcept;
  static void get_data_device(wl_client *client, wl_resource *resource,
                              UInt32 id, wl_resource *seat) noexcept;
