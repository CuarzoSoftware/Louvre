...
#include <protocols/SinglePixelBuffer/single-pixel-buffer-v1.h>
...
static const struct wp_single_pixel_buffer_manager_v1_interface imp{
    ...
    .create_u32_rgba_buffer =
        &GSinglePixelBufferManager::create_u32_rgba_buffer};

void GSinglePixelBufferManager::bind(wl_client *client, void * /*data*/,
...
GSinglePixelBufferManager::GSinglePixelBufferManager(wl_client *client,
                                                     Int32 version,
                                                     UInt32 id) noexcept
...
GSinglePixelBufferManager::~GSinglePixelBufferManager() noexcept {
  LVectorRemoveOneUnordered(client()->imp()->singlePixelBufferManagerGlobals,
                            this);
}

/******************** REQUESTS ********************/

void GSinglePixelBufferManager::destroy(wl_client * /*client*/,
                                        wl_resource *resource) noexcept {
  wl_resource_destroy(resource);
}

void GSinglePixelBufferManager::create_u32_rgba_buffer(wl_client * /*client*/,
                                                       wl_resource *resource,
                                                       UInt32 id, UInt32 r,
                                                       UInt32 g, UInt32 b,
                                                       UInt32 a) noexcept {
  auto &res{*static_cast<GSinglePixelBufferManager *>(
