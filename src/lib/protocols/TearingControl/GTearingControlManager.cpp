...
void GTearingControlManager::bind(wl_client *client, void * /*data*/,
...
GTearingControlManager::GTearingControlManager(wl_client *client, Int32 version,
                                               UInt32 id) noexcept
...
GTearingControlManager::~GTearingControlManager() noexcept {
  LVectorRemoveOneUnordered(client()->imp()->tearingControlManagerGlobals,
                            this);
}

/******************** REQUESTS ********************/

void GTearingControlManager::get_tearing_control(
...
void GTearingControlManager::destroy(wl_client * /*client*/,
