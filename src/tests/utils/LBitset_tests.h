...
void LBitset_test_03() {
  ...
  LAssert("LBitset value should be A | C",
          bitset == (A | C) && bitset == (A | C));
}
...
void LBitset_test_04() {
  ...
  bitset |= B;
  LAssert("LBitset value should be A | B",
          bitset == (A | B) && bitset == (A | B));
  bitset = bitset | C;
  LAssert("LBitset value should be A | B | C",
          bitset == (A | B | C) && bitset == (A | B | C));
  bitset &= C;
  ...
  bitset = A | B | C | D | E | F;
  bitset = ~bitset;
  LAssert("LBitset value should be G | H",
          bitset == (G | H) && bitset == (G | H));
}
