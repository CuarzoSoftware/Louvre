...
class CZ::Protocols::BackgroundBlur::RBackgroundBlur final : public LResource
{
public:
    ...
    static void set_color_scheme(wl_client *client, wl_resource *resource, UInt32 colorScheme);
...
private:
    ...
    RBackgroundBlur(CZBitset<LBackgroundBlur::MaskingCapabilities> maskCaps, Wayland::RWlSurface *surfaceRes, UInt32 id, Int32 version) noexcept;
