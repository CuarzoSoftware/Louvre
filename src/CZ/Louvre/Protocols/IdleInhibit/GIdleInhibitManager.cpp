...
void GIdleInhibitManager::bind(wl_client *client, void */*data*/, UInt32 version, UInt32 id) noexcept
{
...
{
    new RIdleInhibitor(static_cast<Wayland::RSurface*>(wl_resource_get_user_data(surface))->surface(),
