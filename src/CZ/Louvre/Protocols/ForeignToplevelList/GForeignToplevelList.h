...
class CZ::Protocols::ForeignToplevelList::GForeignToplevelList final : public LResource
{
public:
...
private:
    friend class CZ::Protocols::ForeignToplevelList::RForeignToplevelHandle;
    bool m_stopped { false };
    bool m_finished { false };
    LGLOBAL_INTERFACE
    GForeignToplevelList(wl_client *client, Int32 version, UInt32 id);
