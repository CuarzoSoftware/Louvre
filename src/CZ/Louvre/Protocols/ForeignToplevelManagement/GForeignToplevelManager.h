...
class CZ::Protocols::ForeignToplevelManagement::GForeignToplevelManager final : public LResource
{
public:
...
private:
    ...
    LGLOBAL_INTERFACE
    GForeignToplevelManager(wl_client *client, Int32 version, UInt32 id);
