...
class CZ::Protocols::PointerConstraints::RLockedPointer final : public LResource
{
public:
    ...
    static void set_cursor_position_hint(wl_client *client, wl_resource *resource, Float24 x, Float24 y) noexcept;
...
private:
    friend class CZ::Protocols::PointerConstraints::GPointerConstraints;
    RLockedPointer(GPointerConstraints *pointerConstraintsRes,
                   LSurface *surface,
