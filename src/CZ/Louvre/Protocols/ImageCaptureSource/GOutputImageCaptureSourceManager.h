...
class CZ::Protocols::ImageCaptureSource::GOutputImageCaptureSourceManager final : public LResource
{
public:
...
private:
    LGLOBAL_INTERFACE
    GOutputImageCaptureSourceManager(wl_client *client, Int32 version, UInt32 id);
