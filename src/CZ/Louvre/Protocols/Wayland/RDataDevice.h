...
class CZ::Protocols::Wayland::RDataDevice final : public LResource
{
public:
    ...
    void enter(UInt32 serial, RWlSurface *surface, Float24 x, Float24 y, RDataOffer *offer) noexcept;
    void leave() noexcept;
...
private:
    friend class CZ::Protocols::Wayland::GDataDeviceManager;
    friend class CZ::LDND;

    RDataDevice(GDataDeviceManager *dataDeviceManagerRes, GSeat *seatRes, Int32 id) noexcept;
