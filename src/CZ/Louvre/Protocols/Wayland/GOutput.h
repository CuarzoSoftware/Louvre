...
class CZ::Protocols::Wayland::GOutput final : public LResource
{
public:
    ...
    // Since 1
    void geometry(Int32 x, Int32 y, Int32 physicalWidth, Int32 physicalHeight, RSubpixel subpixel, const char *make, const char *model, CZTransform transform) noexcept;
...
private:
    ...
    friend class GammaControl::RZwlrGammaControlV1;
    LGLOBAL_INTERFACE
    ...
    std::vector<GammaControl::RZwlrGammaControlV1*> m_gammaControlRes;
};
