...
#include <CZ/Louvre/Manager/LActivationToken.h>
 ...
 * which can be accessed globally via CZ::activationTokenManager().
 *
 * To disable this protocol, remove its global from LCompositor::createGlobalsRequest()
 *
 * @see LActivationToken
 */
class CZ::LActivationTokenManager : public LFactoryObject
{
public:
...
private:
    ...
    CZWeak<LActivationToken> m_token;
};
