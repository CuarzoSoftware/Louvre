...
Int32 LTouch::GetTouchEventId(const CZEvent &e) noexcept
{
    switch (e.type())
    {
    case CZEvent::Type::TouchDown:
        return static_cast<const CZTouchDownEvent&>(e).id;
    case CZEvent::Type::TouchMove:
        return static_cast<const CZTouchMoveEvent&>(e).id;
    case CZEvent::Type::TouchUp:
        return static_cast<const CZTouchUpEvent&>(e).id;
    default:
        return -1;
    }
}
...
LTouchPoint *LTouch::createOrGetTouchPoint(const CZTouchDownEvent &event) noexcept
{
