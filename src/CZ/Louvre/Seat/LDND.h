 ...
 */
class CZ::LDND : public LFactoryObject
{
public:
     ...
     */
    ~LDND() noexcept { notifyDestruction(); }
     ...
     */
    void setFocus(LSurface *surface, SkPoint localPos) noexcept;
     ...
     */
    void sendMoveEvent(SkPoint localPos, UInt32 ms) noexcept;
     ...
     * or a touch point.
     *
     * @note If the event was generated by an event like CZKeyboardEnterEvent, the default implementation treats it as a pointer session.
     *
...
private:
    ...
    std::shared_ptr<CZEvent> m_triggeringEvent { std::make_shared<CZPointerButtonEvent>() };
