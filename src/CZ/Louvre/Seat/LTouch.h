 ...
 */
class CZ::LTouch : public LFactoryObject
{
public:
    ...
    /// Returns -1 on error
    static Int32 GetTouchEventId(const CZEvent &e) noexcept;
     ...
     */
    LTouchPoint *createOrGetTouchPoint(const CZTouchDownEvent &event) noexcept;
     ...
     */
    void sendFrameEvent(const CZTouchFrameEvent &event) noexcept;
     ...
     */
    void sendCancelEvent(const CZTouchCancelEvent &event) noexcept;
     ...
     */
    virtual void touchDownEvent(const CZTouchDownEvent &event);
     ...
     */
    virtual void touchMoveEvent(const CZTouchMoveEvent &event);
     ...
     */
    virtual void touchUpEvent(const CZTouchUpEvent &event);
     ...
     */
    virtual void touchFrameEvent(const CZTouchFrameEvent &event);
     ...
     */
    virtual void touchCancelEvent(const CZTouchCancelEvent &event);
